...
class PaginationComponent extends React.Component {
    ...
    setPage(page) {
        ...
        this.props.pageSize !== 0 ? this.props.onChangePage(pageOfItems) : this.props.onChangePage(this.props.items);
    }
    ...
    render() {
        ...
        if (!pager.pages || pager.pages.length <= 1 || this.props.pageSize === 0) {
        ...
        return (
            <Pagination aria-label="Page navigation example">
                <PaginationItem disabled={pager.currentPage === 1}>
                    <PaginationLink first onClick={() => this.setPage(1)}/>
                </PaginationItem>
                <PaginationItem disabled={pager.currentPage === 1}>
